...
<table class="highlight responsive-table">
        <thead>
          <tr>
              ...
              <th data-field="Nom. Enc">Nom. Encargado</th>
              <th data-field="Puesto del enc.">Nom. Proyecto</th>-->
          </tr>
        </thead>
        <tbody>
        	<?php foreach ($datos as $data) {
              ...
              #echo "<td>".$data['nom_encargado']."</td>";
              #echo "<td>".$data['puesto_encargado']."</td>";
              echo "<td><a href='index.php?c=controller&a=viewDataProcess&mat=".$data['matricula']."' class='waves-effect waves-light btn-flat teal'><font color='white'>Ver</font></a></td>";
